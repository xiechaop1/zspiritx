...
class Guide extends Action
{
    ...
    public function run()
    {
        ...
        $type = !empty($this->_get['type']) ? $this->_get['type'] : 'guide';
...
//            [
//                'title' => '游戏介绍-QA',
//                'content' => '如果您有任何问题，欢迎<span style="color:red; font-weight: bold;">您和管理员联系：18500041193（可以加微信）</span>。最后祝您玩儿的开心！灵镜新世界，感谢您的到来！现在，您可以点击"继续"去探索吧！',
