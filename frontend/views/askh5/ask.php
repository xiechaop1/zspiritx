...
<!--                                </div>-->
            ...
            <label class="fs-30 ask_answer_hide" style="color: yellow;" >关闭</label>-->
                    ...
                    <div class="answer-border" >
                        <form id="ask_form">
                    <input class="form-check-label fs-30" x-webkit-speech="x-webkit-speech"   type=text <?= (!empty($str['keyboard']) ? 'readonly' : '') ?> name="ask_answer_txt" class="form-control" placeholder="请输入答案" style="width: 80%; color: yellow;">
