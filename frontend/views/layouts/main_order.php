...
<?php $this->beginPage() ?>
    ...
    <body>
    <?php $this->beginBody() ?>
    <div class="container-fluid bg-F5 h-100">
        <header>
            <div class="bg-FB row justify-content-center shadow fs-12">
                <div class="w-1200">
                    <div class="login height d-flex justify-content-between">
                        <div class="d-flex align-items-center">
                            <?php if (Yii::$app->user->isGuest) {
                                ?>
                                <a class="pointer" data-toggle="modal" data-target="#login">登录/注册</a>
                                <?php
                            } else {
                                ?>
                                <a class="pointer" href="/homepage">首页&nbsp;</a>
                                <a class="pointer"
                                   href="/account/information">我的个人中心&nbsp;<?= Yii::$app->user->identity->username ?>
                                    ，欢迎您</a><a class="logout pointer text-99 ml-2">退出</a>
                                <?php
                            }
                            ?>
                        </div>
                        <div class="d-flex align-items-center">
                            <a class="ml-15 online" href="#">联系在线客服</a>
                            <a class="ml-15" href="#">微信订阅号</a>
                            <a class="ml-15" href="#">中文/English</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center bg-FF shadow">
                <div class="w-1200">
        ...
        <div class="row justify-content-center pb-5 bg-F5 mt-5">
            <?= $content ?>
        </div>
