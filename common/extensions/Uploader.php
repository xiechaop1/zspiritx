...
use backend\extensions\表单名称;
use backend\extensions\配置项;
...
//        $this->stateMap['ERROR_TYPE_NOT_ALLOWED'] = iconv('unicode', 'utf-8', $this->stateMap['ERROR_TYPE_NOT_ALLOWED']);
    ...
    private function upFile()
    {
        ...
        Yii::warning($this->filePath);
        $this->_ossClient->uploadFile($this->_bucket, $this->filePath, $file['tmp_name']);
...
//        }
    ...
    private function upBase64()
    {
        ...
        $this->_ossClient->putObject($this->_bucket, $this->filePath, $img);
        $this->stateInfo = $this->stateMap[0];
    }
