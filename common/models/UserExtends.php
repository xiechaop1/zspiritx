...
class UserExtends extends \common\models\gii\UserExtends
{
    ...
    public static $userGradeLevelMap = [
        ...
        self::USER_GRADE_PRIMARY_TWO => 2,
        self::USER_GRADE_PRIMARY_THREE => 3,
        self::USER_GRADE_PRIMARY_FOUR => 4,
        self::USER_GRADE_PRIMARY_FIVE => 5,
        self::USER_GRADE_PRIMARY_SIX => 6,
        self::USER_GRADE_PRIMARY_SEVEN => 7,
        self::USER_GRADE_PRIMARY_EIGHT => 8,
        self::USER_GRADE_PRIMARY_NINE => 9,
        self::USER_GRADE_JUNIOR_ONE => 7,
        self::USER_GRADE_JUNIOR_TWO => 8,
        self::USER_GRADE_JUNIOR_THREE => 9,
        self::USER_GRADE_SENIOR_ONE => 10,
        self::USER_GRADE_SENIOR_TWO => 11,
        self::USER_GRADE_SENIOR_THREE => 12,
