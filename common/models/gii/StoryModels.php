...
class StoryModels extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['active_model_inst_u_id', 'scan_image_id', 'model_inst_u_id', 'active_next', 'story_model_name', 'story_model_desc', 'dialog', 'model_group', 'use_group_name', 'story_model_image', ], 'string'],
        ];
    }
