...
?>
    ...
    <div class="box box-primary">
        <div class="box-header">
            <?= \yii\bootstrap\Html::a('添加', '/story/edit', [
...
//                        'filter'    => Html::activeInput('text', $searchModel, 'id'),
                    ...
                    [
                        ...
                        'value' => function ($model) {
                            ...
                            $ret = !empty(\common\models\Story::$storyType2Name[$model->story_type])
                                ? \common\models\Story::$storyType2Name[$model->story_type]
                                : '未知';
...
echo $form->field($storyModel, 'title')->label('标题');
?>
