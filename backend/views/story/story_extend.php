    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
            ...
            echo \backend\widgets\GridView::widget([
                ...
                'afterRow' => function ($model, $key, $index) use ($storyExtendModel, $storyList) {
                    Modal::begin([
                    ...
                    ?>
                    <?php
                    echo $form->field($storyExtendModel, 'story_id')->dropDownList($storyList, ['value' => $model->story_id])->label('剧本');
                    echo $form->field($storyExtendModel, 'price')->textInput(['value' => $model->price])->label('原价');
                    echo $form->field($storyExtendModel, 'curr_price')->textInput(['value' => $model->curr_price])->label('现价');
                    ?>
...
//                        'filter'    => Html::activeInput('text', $searchModel, 'id'),
                    ...
                    [
                        ...
                        'filter' => Html::activeInput('text', $searchModel, 'story_id',['placeholder'=>'剧本ID']),
                    ],
                    [
                        'label' => '原价',
                        'attribute' => 'price',
...
echo $form->field($storyExtendModel, 'story_id')->dropDownList($storyList)->label('剧本');
echo $form->field($storyExtendModel, 'price')->label('原价');
echo $form->field($storyExtendModel, 'curr_price')->label('现价');
