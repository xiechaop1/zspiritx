...
?>
    ...
    <div class="box box-primary">
        <div class="box-header">
            <?= \yii\bootstrap\Html::a('添加', '/model/story_model_detail_edit', [
                    ...
                    [
                        ...
                        'buttons' => [
                            'edit' => function ($url, $model, $key) {
                                return \yii\helpers\Html::a('编辑', \yii\helpers\Url::to(['model/story_model_detail_edit', 'id' => $model->id]), ['class' => 'btn btn-xs btn-primary']);
                            },
