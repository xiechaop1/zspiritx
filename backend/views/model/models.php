...
?>
    ...
    <div class="box box-primary">
        <div class="box-header">
            <?= \yii\bootstrap\Html::a('添加', '/model/models_edit', [
        ...
        <div class="box-body">
            ...
            echo \backend\widgets\GridView::widget([
                ...
                'afterRow' => function ($model, $key, $index) use ($models) {
                    Modal::begin([
...
//                        'filter'    => Html::activeInput('text', $searchModel, 'id'),
                    ...
                    [
                        ...
                        'format'    => 'raw',
                        'value' => function ($model) {
                            return !empty(\common\models\Models::$isActive2Name[$model->is_active]) ?
                                \common\models\Models::$isActive2Name[$model->is_active] : '未知';
                        },
                    ],
                    [
                        'attribute' => 'length',
                    ...
                    [
                        ...
                        'buttons' => [
                            'edit' => function ($url, $model, $key) {
                                return \yii\helpers\Html::a('编辑', \yii\helpers\Url::to(['model/models_edit', 'id' => $model->id]), ['class' => 'btn btn-xs btn-primary']);
                            },
