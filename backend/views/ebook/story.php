...
?>
    ...
    <div class="box box-primary">
        <div class="box-header">
            <?= \yii\bootstrap\Html::a('添加', '/ebook/edit', [
        ...
        <div class="box-body">
            ...
            echo \backend\widgets\GridView::widget([
                ...
                'afterRow' => function ($model, $key, $index) use ($ebookModel) {
                    Modal::begin([
...
//                        'filter'    => Html::activeInput('text', $searchModel, 'id'),
                    ...
                    [
                        ...
                        'attribute' => 'story_id',
                        'format'    => 'raw',
                        'filter' => Html::activeInput('text', $searchModel, 'story_id',['placeholder'=>'标题']),
                    ],
                    [
                        'label' => '创建时间',
                        'format' => 'raw',
                    ...
                    [
                        ...
                        'buttons' => [
                            'edit' => function ($url, $model, $key) {
                                return \yii\helpers\Html::a('编辑', \yii\helpers\Url::to(['ebook/edit', 'id' => $model->id]), ['class' => 'btn btn-xs btn-primary']);
                            },
...
echo $form->field($ebookModel, 'title')->label('标题');
?>
