    ...
    public function run()
    {
        ...
        if (Yii::$app->request->isAjax) {
            ...
            switch (Net::post('action')) {
                ...
                case 'lock':
                    if ($music) {
                        $music->music_status = \common\models\Music::MUSIC_STATUS_LOCK;
                        if ($music->save()) {
                ...
                case 'unlock':
                    if ($music) {
                        $music->music_status = \common\models\Music::MUSIC_STATUS_NORMAL;
                        if ($music->save()) {
                ...
                case 'sync':
                    if ($music) {
                        $music->music_type = \common\models\Music::MUSIC_TYPE_NORMAL;
                        if ($music->save()) {
        ...
        return $this->controller->render('static_musiclist', [
