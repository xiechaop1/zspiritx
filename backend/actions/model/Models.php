...
class Models extends Action
{
    ...
    public function run()
    {
        ...
        if ($storyModelId) {
            $model = \common\models\Models::findOne($storyModelId);
        } else {
            $model = new \common\models\Models();
        }

        if (Yii::$app->request->isAjax) {
            $id = Net::post('id');
            $storyModel = \common\models\Models::findOne($id);
        ...
        $searchModel = new \backend\models\Models();
        $dataProvider = $searchModel->search(\Yii::$app->request->getQueryParams());

        return $this->controller->render('models', [
