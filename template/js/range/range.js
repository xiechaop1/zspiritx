(function($, window, document, undefined) {
    ...
    jRange.prototype = {
        ...
        <div class="d-flex absolute left-0 top-0">\
            <div class="pointer-label text-99">123456</div>-\
            <div class="pointer-label text-99 right-0">456789</div>\
        </div>\
			<div class="back-bar mt-3">\
        ...
        onDragEnd: function(e) {
            ...
            $(document).off('.slider');
            this.options.callback.call(this,this.getValue())
            this.inputNode.change()
        },
        ...
        setPosition: function(pointer, position, isPx, animate) {
            var leftPos, lowPos = this.lowPointer.position().left, highPos = this.highPointer.position().left, circleWidth = this.highPointer.width() / 2;
            if (!isPx) {
