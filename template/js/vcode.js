...
/*    $('.vcode').unbind('click').on('click',function(){
        if(!this.wait){
            ...
            var mobile_dom = $('input[name="phone"],input[name="mobile"]').parents('div[name]:not(.d-none),tab-pane:not(.active),section:not(.d-none)').find('input[name="phone"],input[name="mobile"]')

            var email = email_dom.val()
            var mobile = mobile_dom.val()
            console.log(email,email_dom.hasClass('is-valid'))
            if(!mobile_dom.hasClass('is-invalid')&&$(this).hasClass('vcode-phone')&&!$(this).hasClass('disable')){
                //等待验证码时间
                this.wait = true;
            ...
            else if(email_dom.hasClass('is-valid')&&$(this).hasClass('vcode-mail')){
                //等待验证码时间
                this.wait = true;
                ...
                if($(this).hasClass('vcode-mail')){
                    $.alert('邮箱有误！')
                }else if($(this).hasClass('vcode-phone')&& mobile_dom.hasClass('is-invalid')){
                    $.alert('手机号有误！');
                    console.log('')
                }
        ...
        $('.vcode').unbind('click').click(function () {
            if(!this.wait){
                var that = this;
